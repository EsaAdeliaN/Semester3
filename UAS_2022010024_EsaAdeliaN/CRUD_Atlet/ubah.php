...
$siswa = query("SELECT * FROM siswa WHERE id_atlet = $id_atlet")[0];
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Atlet</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="id_atlet" class="form-label">Nomor Anggota</label>
                        <input type="number" class="form-control w-50" id="id_atlet" value="<?= $siswa['id_atlet']; ?>" name="id_atlet" readonly>
                    </div>
                    <div class="mb-3">
