...
$siswa = query("SELECT * FROM siswa ORDER BY id_atlet DESC");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Atlet</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['geup']; ?></td>
                                <td>
                                    <button class="btn btn-success btn-sm text-white detail" data-id="<?= $row['id_atlet']; ?>" style="font-weight: 600;"><i class="bi bi-info-circle-fill"></i>&nbsp;Detail</button> |

                                    <a href="ubah.php?id_atlet=<?= $row['id_atlet']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapus.php?id_atlet=<?= $row['id_atlet']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
